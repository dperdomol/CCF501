<?php
    ...
    function insert_subject($subject){
        ...
        $result = mysqli_query($db, $sql);
        confirm_result_set($result);
        //INSERT stataments => $result is true/false
        if($result){
            return true;
        }else{
            //Insert Failed
    ...
    function update_subject($subject){
        ...
        $sql .= "LIMIT 1";
        $result = mysqli_query($db, $sql);
        //UPDATE stataments => $result is true/false
        confirm_result_set($result);
        if($result){
            return true;
        }else{
    ...
    function delete_subject($id){
        ...
        $result = mysqli_query($db, $sql);
        //DELETE stataments => $result is true/false
        if($result){
            return true;
        }else{
            //DELETE failed
    ...
    function find_product_by_subject_id($subject_id){
        global $db;
